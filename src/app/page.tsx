  ...
  return (
    <div className=" flex flex-wrap justify-center">
      ...
      <div id="introduction" className="pt-40">
        ...
        <section id="school" className="bg-gradient-to-r from-green-600 to-purple-700 via-blue-400 w-11/12 ml-auto mr-auto mb-20">
        ...
        <section id="projects" className="bg-gradient-to-b from-purple-700 to-yellow-400 via-red-600 w-11/12 ml-auto mr-auto mb-20">
          <ProjectsSection />
        </section>
