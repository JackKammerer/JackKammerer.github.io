...
export default function Chair(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF(process.env.NEXT_PUBLIC_BUCKET + 'chair2/scene.gltf') as GLTFResult
  return (
...
useGLTF.preload(process.env.NEXT_PUBLIC_BUCKET + 'chair2/scene.gltf')
